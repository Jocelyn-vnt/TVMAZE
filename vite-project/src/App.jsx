  ...
  return (
    <div className="">
      ...
      <div className="flex items-center place-content-between rounded-b-md shadow-sm shadow-accent py-4">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex justify-center items-center cursor-pointer select-none text-primary rounded-sm bg-black text-sm outline-none focus:bg-accent data-[state=open]:bg-accent"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">
          ...
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="" className="size-10 stroke-primary">
